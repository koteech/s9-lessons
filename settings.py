...
student = 'livingforsuccess',  # ваш_логин
pg_settings = {
    'host': 'rc1b-rjgttxbo0g1shtkx.mdb.yandexcloud.net',  # хост_вашего_postgresql
    'port': 6432,  # порт_вашего_postgresql
    'dbname': 'sprint9dwh',  # название_бд
    'username': 'sprint9dwh',  # имя_пользователя_для_подключения
    'password': 'sprint9dwh'  # пароль_для_подключения
}
...
path_s9_srv = 'C:/Users/koteech/YandexDisk/trainings/YaPraktikum/sprint-9-sample-service/service_stg'
